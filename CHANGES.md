...
* Fixed the game not automatically flushing content from memory on level changes when low on memory – if you were experiencing crashes on a low-memory system, this might help
